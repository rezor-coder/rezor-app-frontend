...
const SendSOL = props => {
  ...
  const decim =
    props.route?.params?.walletData?.no_of_decimals > 8
      ? 8
      : props.route?.params?.walletData?.no_of_decimals;
                ...
                <View
                  ...
                  <Text
                    ...
                    <Text
                      ...
                      decim,
                    )} ${walletData?.coin_symbol.toUpperCase()}`}</Text>
                  </Text>
                </View>
