...
import CountryCodeStyle from './CountryCodesStyle';
        ...
        style={{ flex: 1, backgroundColor: ThemeManager.colors.bg }}>
          <SafeAreaView style={CountryCodeStyle.mainViewStyle}>
            <View style={{ width: '100%', }}>
              ...
              />
              <BorderLine
                borderColor={{ backgroundColor: ThemeManager.colors.viewBorderColor, marginBottom: 15 }}
              />
            </View>
            ...
            <View style={{ marginTop: 5, paddingHorizontal: 15, }} >
              <SearchBar
                titleStyle={{ color: ThemeManager.colors.textColor ,fontFamily:fonts.medium}}
                text={Search}
                width="100%"
                placeholder="Search"
                returnKeyType={'done'}
            ...
            style={{
              ...
              <FlatList
                ...
                renderItem={({ item }) => (
                  <TouchableOpacity
                    style={[CountryCodeStyle.FlatlistCell,{borderColor:ThemeManager.colors.viewBorderColor}]}
                    ...
                    <View style={CountryCodeStyle.FlatListCellSubView}>
                      <View style={CountryCodeStyle.FlatlistCellLeftView}>
                        ...
                        <Text style={[CountryCodeStyle.countryCodeStyle, { color: ThemeManager.colors.textColor }]}>
                          {this.props?.hideCode ? '' : item.dial_code}
                        </Text>
                      </View>
                    </View>
