...
import styles from './RezorSupportStyle';

let showLoader = true;
const RezorSupport = props => {
      ...
      <View style={[styles.centeredView, props.ModalStyle]}>
        ...
        <View
          ...
          {/* <BasicButton
            ...
            text={'Rezor'}
            colorGradient={selectedButton === 'Rezor' ? false : true}
            textStyle={{
              fontSize: 14,
              fontFamily: Fonts.regular,
              color:
                selectedButton === 'Rezor'
                  ? Colors.white
                  : Colors.lightGrey2,
            }}
            rightImage
        ...
        {/* <View
          ...
          <BasicButton
            ...
            rightImage
            icon={Images.imgFangArt}
            colorGradient={selectedButton === 'RezorMarket' ? false : true}
            textStyle={{
              fontSize: 14,
              fontFamily: Fonts.regular,
              color:
                selectedButton === 'RezorMarket'
                  ? Colors.white
                  : Colors.lightGrey2,
            }}
            iconStyle={{
