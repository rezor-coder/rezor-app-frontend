...
import { styles } from './SwapScreenBnbStyle';
// import { TouchableOpacity } from 'react-native-gesture-handler';
import { BigNumber } from 'bignumber.js';
import FastImage from 'react-native-fast-image';
import { useDispatch } from 'react-redux';
import Web3 from 'web3';
import Token_List from '../../../../ABI/bnbList';
import ROUTER_ABI from '../../../../ABI/routerBnb.ABI.json';
import TOKEN_ABI from '../../../../ABI/tokenContractBnb.ABI.json';
...
// let routerAddress = '0x744A4c9c9F40A443ac2A5747D4f3b773e5d86763'; // mainnet saitaswap router address  bnb
...
const SwapScreenBnb = ({ slippage, timeout }) => {
  ...
  const getWeb3Object = () => {
    return constants.network == 'mainnet'
      ...
      : new Web3('https://rinkeby.infura.io/v3/ef700abe941041fe8556c43d40f131ab',);
    ...
    return new Promise((resolve, reject) => {
      ...
      getWeb3Object()
        ...
        .then(async gasPrice => {
          ...
          if (tokenFirst.coin_symbol.toLowerCase() == 'bnb') {
            // ETH to Token 
            setUserApproval(true);
            let swapTransaction;
            if (type == SELECTED_INPUT.firstInput) {
            ...
            if (tokenSecond.coin_symbol.toLowerCase() == 'bnb') {
  ...
  const makeTransaction = async (
    ...
    let rawTransaction = {
      ...
      chainId: constants.network == 'testnet' ? 97 : 56,
    };
                  ...
                  if (tokenOneAmount == undefined || tokenOneAmount == 0) {
                    ...
                    if (isApproved) {
                      ...
                      if (ethBal - Singleton.getInstance().exponentialToDecimal(totalFee) < 0) {
                        ...
                        Singleton.showAlert("You don't have enough bnb to perform transaction",);
                        return;
                      }
                      setSwapModal(true);
                    } else {
                      ...
                      Alert.alert('Approval', `Pay ${(
                        ...
                        gasEstimate *
                        GAS_FEE_MULTIPLIER
                      ).toFixed(6,)} BNB transaction fee for token approval`,
                        [{
                          text: 'Approve',
                          onPress: () => {
                            getApproval();
