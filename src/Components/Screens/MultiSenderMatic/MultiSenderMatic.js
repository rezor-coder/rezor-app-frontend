...
class MultiSenderMatic extends Component {
  constructor() {
    super();
    this.state = {
      myNo: '',
  ...
  componentDidMount() {
    ...
    Singleton.getInstance()
      .newGetData(`${Singleton.getInstance().defaultMaticAddress}_pk`)
      .then(bnbPvtKey => {
        //console.log('bnbPvtKey--------', bnbPvtKey);
    ...
    //console.log('toAddress', valueInCoin);
  }
  ...
  getBnbGasLimit(res) {
    let data = {
      ...
      to: Singleton.getInstance().defaultMaticAddress,
    ...
    this.props
      ...
      .then(nonce => {
        ...
        Singleton.getInstance()
          ...
          .then(txn_raw => {
            console.log('chk txn_raw_bnb:::', txn_raw);
          ...
          .catch(err => {
           ...
           }else if(err?.toString()?.includes("Couldn't connect")){
            Singleton.showAlert(constants.NO_NETWORK)
           }else{
      ...
      .catch(err => {
        console.log('Chk bnb nonce err::::::::', err);
      });
  }
    ...
    this.props
      ...
      .then(nonce => {
        ...
        Singleton.getInstance()
          ...
          .then(txn_raw => {
            // console.log('chk txn_raw_bnb_token:::', txn_raw);
  ...
  saveTxn(hash, cmsnAmt) {
    let data = {
      from: Singleton.getInstance().defaultMaticAddress,
      to: MultiSenderMaticContractAddress,
      amount: this.state.amount,
