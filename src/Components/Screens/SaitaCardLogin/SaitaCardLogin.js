  ...
  const proceedLogin = () => {
    ...
    dispatch(loginCards({ data }))
      .then(res => {
        ...
        // console.warn('MM',"loginCards res::::::::", res);

        if (res?.data?.mobile_no_updated == '0') {
          setisLoading(false);
          ...
          Singleton.getInstance().newSaveData(Constants.isLoginCard, 'true');
          getUserDetail(res.data.jwt);
        }
      })
      .catch(err => {
        //  console.warn('MM',"loginCards eerrr:::::::::", err);
        setisLoading(false);
          ...
          <View
            ...
            <View
              ...
              <BasicButton
                ...
                text={'Pay using Visa/Mastercard(Epay)'}
                textStyle={{
                  fontSize: 16,
                  fontFamily: Fonts.medium,
                  color: ThemeManager.colors.textColor,
