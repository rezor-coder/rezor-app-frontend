  ...
  return dispatch => {
    return new Promise((resolve, reject) => {
      APIClient.getInstance()
        .post(API_SEARCH_TOKEN, data, access_token)
        .then(response => {
          let result = response;
          resolve(result);
        })
...
export const addToken = ({data, access_token}) => {
  return dispatch => {
    return new Promise((resolve, reject) => {
      console.warn('MM','add token::::1111', data)
      APIClient.getInstance()
        .post(API_ADD_TOKEN_V2, data, access_token)
        .then(response => {
          let result = response;
          resolve(result);
        })
...
export const getCoinGeckoSymbols = ({coin_symbol, access_token}) => {
  return dispatch => {
    return new Promise((resolve, reject) => {
      APIClient.getInstance()
        .get(API_COIN_GECKO + coin_symbol, access_token)
        .then(response => {
          let result = response;
          resolve(result.data);
        })
...
export const addNft = ({data, access_token}) => {
  return dispatch => {
    return new Promise((resolve, reject) => {
      APIClient.getInstance()
        .post(API_NFT, data, access_token)
        .then(response => {
          let result = response;
          resolve(result);
        })
...
export const addBscNft = ({data, access_token}) => {
  return dispatch => {
    return new Promise((resolve, reject) => {
      APIClient.getInstance()
        .post(API_NFT_BSC, data, access_token)
        .then(response => {
          let result = response;
...
export const getNftList = ({wallet_addres, access_token}) => {
  return dispatch => {
    return new Promise((resolve, reject) => {
      APIClient.getInstance()
        .get(API_NFT_LIST + wallet_addres, access_token)
        .then(response => {
          let result = response;
...
export const getNftGasEstimate = ({data, access_token}) => {
  return dispatch => {
    return new Promise((resolve, reject) => {
      APIClient.getInstance()
        .post(API_NFT_GAS_ESTIMATE, data, access_token)
        .then(response => {
          let result = response;
